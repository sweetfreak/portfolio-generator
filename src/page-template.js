...
const generateAbout = aboutText => {
    //if there is not about text
    if (!aboutText) {
        return "";
    }
    //if there IS about text
    return `
...
//This code below was refactored to the above - condenses to only two functions
//and joins the map and filter functions together

    // //if project.feature returns true, get an array of the featured projects
    ...
    // //html for feature project, uses map feature
    ...
    // `;
    // })
    // //created html for nonfeatured projects, using map feature
